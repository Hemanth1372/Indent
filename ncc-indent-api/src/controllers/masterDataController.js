...
export async function listMasterData(req, res, next) {
  try {
    ...
    if (['responsibility-master', 'project-master', 'activity-master', 'item-master', 'service-order-master', 'delivery-point-master', 'location-master', 'warehouse-master', 'warehouse-bin-master', 'business-partner-master'].includes(req.params.masterKey)) {
